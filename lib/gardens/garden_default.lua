...
function l_system_instructions.get_instruction(instruction_id)
  ...
  if (instruction_id == 1) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"F","F++F++F|F-F++F"}
    -- instruction.ruleset[1] = {"F","F++F++F|F-F++F|F|++F|++F|F-F|++FFF|FFF"}
  ...
  elseif (instruction_id == 2) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"F", "FF+[+F-F-F]-[-F+F+F]"}
    instruction.axiom = "F"
    instruction.max_generations = 2
    instruction.length = screen_size.y/8
  ...
  elseif (instruction_id == 3) then
    ...
    instruction.start_from = vector:new(screen_size.x/2, 30)
    instruction.ruleset = {}
    instruction.ruleset[1] = {"M","OA++pA----FA[-OA----MA]++"}
    instruction.ruleset[2] = {"F","+OA--PA[---MA--FA]+"}
    instruction.ruleset[3] = {"O","-MA++FA[+++OA++PA]-"}
    instruction.ruleset[4] = {"P","--OA++++MA[+PA++++FA]--FA"}
    instruction.ruleset[5] = {"A",""}
  ...
  elseif (instruction_id == 4) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"F","F--F--F--G"}
    instruction.ruleset[2] = {"G","GG"}
  ...
  elseif (instruction_id == 5) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"X","+YF-XFX-FY+"}
    instruction.ruleset[2] = {"Y","-XF+YFY+FX-"}
    instruction.axiom = "X"
  ...
  elseif (instruction_id == 6) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"F","FF+F+F+F+FF"}
  ...
  elseif (instruction_id == 9) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"F","[+FG-F]F[-FG+F]"}
  ...
  elseif (instruction_id == 10) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"X", "FGG[+X][-X]GXF"}
    instruction.ruleset[2] = {"F","F"}
    instruction.axiom = "X"
    instruction.max_generations = 3
  ...
  elseif (instruction_id == 11) then
    ...
    instruction.ruleset = {}
    instruction.ruleset[1] = {"F","G[+F]G[-F]+F"}
    instruction.ruleset[2] = {"G","GG"}
    instruction.axiom = "F"
    instruction.max_generations = 3
    instruction.length = 20
